                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
                    ...
                    <div className="flex items-center gap-6 font-mono text-xs text-white/40">
                      <span className="flex items-center gap-1.5">
                        <HiEye className="w-3.5 h-3.5" /> {formatCompactNumber(featuredArticle.jumlahView)}
                      </span>
                      <span className="flex items-center gap-1.5">
                        <HiHeart className="w-3.5 h-3.5" /> {formatCompactNumber(featuredArticle.jumlahLike)}
                      </span>
                      <span className="flex items-center gap-1.5">
                        <HiChatBubbleLeftRight className="w-3.5 h-3.5" /> {formatCompactNumber(featuredArticle.commentCount ?? 0)}
                      </span>
                      ...
                      <div className="group h-full rounded-xl overflow-hidden bg-card/80 backdrop-blur-sm border border-border/20 hover:border-primary/30 transition-all duration-500 hover:shadow-[0_8px_40px_-12px_rgba(6,182,212,0.15)] hover:-translate-y-1">
                        ...
                        <div className="p-5 flex flex-col flex-1">
                          ...
                          <div className="flex items-center gap-4 font-mono text-[10px] text-muted-foreground/50 pt-3 border-t border-border/10">
                            <span className="flex items-center gap-1">
                              <HiEye className="w-3 h-3" /> {formatCompactNumber(article.jumlahView)}
                            </span>
                            <span className="flex items-center gap-1">
                              <HiHeart className="w-3 h-3" /> {formatCompactNumber(article.jumlahLike)}
                            </span>
                            <span className="flex items-center gap-1">
                              <HiChatBubbleLeftRight className="w-3 h-3" /> {formatCompactNumber(article.commentCount ?? 0)}
                            </span>
