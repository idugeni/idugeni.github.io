...
export default function ProjectDetailError({
  ...
  useEffect(() => {
    console.error("[project-detail] Error boundary caught:", error);
  }, [error]);
    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="mb-6 text-sm text-muted-foreground">
          Terjadi kesalahan saat memuat detail proyek ini. Server mungkin sedang mengalami gangguan sementara.
        </p>
        <div className="flex items-center justify-center gap-3">
          ...
          <Link href="/projects" className="inline-flex items-center gap-2 rounded-md border border-border px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-secondary">
            Kembali ke Proyek
          </Link>
        </div>
        {error.digest && (
