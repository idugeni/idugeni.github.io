    ...
    <section className='py-8 md:py-12 lg:py-16 bg-base-200 border-b border-gray-700'>
      <div className='container mx-auto px-4 md:px-6 lg:px-8'>
        ...
        <p className='text-gray-500 max-w-7xl text-center'>
          ...
          deliver solutions that not only meet but exceed expectations. Through
          our work, we aim to inspire and drive progress, continually striving
          for excellence and setting new standards in the industry.
        </p>
      </div>
    </section>
  )
