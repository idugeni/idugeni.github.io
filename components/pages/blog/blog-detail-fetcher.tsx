...
interface BlogDetailFetcherProps {
  slug: string;
}
...
export function BlogDetailFetcher({ slug }: BlogDetailFetcherProps) {
  ...
  useEffect(() => {
    async function fetchBlogDetail() {
      try {
        ...
        console.error("[BlogDetailFetcher] Error:", err);
        setError(true);
      } finally {
        setLoading(false);
      }
      ...
      <div className="flex min-h-[60vh] items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="mb-6 text-sm text-muted-foreground">
            Artikel tidak ditemukan atau server sedang mengalami gangguan.
          </p>
