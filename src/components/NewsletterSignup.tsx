        ...
        <div className='flex-1 w-full'>
          <div className='bg-base-100 shadow-lg rounded-lg w-full'>
            <div className='p-4 md:p-6 flex flex-col justify-center items-center w-full'>
              ...
              <button
                type='submit'
                className='bg-primary text-base-100 border border-transparent rounded-md py-2 px-4 w-full text-center flex items-center justify-center transition-colors duration-300 hover:bg-primary-dark hover:text-white'
              >
