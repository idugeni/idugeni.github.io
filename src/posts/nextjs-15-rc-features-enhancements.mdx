...
| Feature                | Description                                   |
| ---------------------- | --------------------------------------------- |
| Static Site Generation | More efficient build times                    |
| API Routes             | Support for streaming responses               |
| Image Optimization     | Automatic and device-based image optimization |
...
![Next.js Logo](https://nextjs.org/static/blog/next-15-rc/twitter-card.png")
