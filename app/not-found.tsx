    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden dark">
      ...
      <div className="relative z-10 text-center px-4 max-w-lg">
        ...
        <div className="relative mb-8">
          <h1 className="text-[120px] md:text-[180px] font-orbitron font-bold text-primary/10 leading-none select-none">
            404
          </h1>
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-5xl md:text-7xl font-orbitron font-bold text-primary drop-shadow-[0_0_20px_rgba(6,182,212,0.5)]">
              404
            </span>
          </div>
        </div>

        <h2 className="font-orbitron text-xl md:text-2xl font-bold text-foreground mb-3">
          SIGNAL_LOST
        </h2>
        <p className="font-mono text-sm text-muted-foreground mb-2">
          Halaman yang Anda cari tidak ditemukan dalam sistem.
        </p>
        <p className="font-mono text-xs text-muted-foreground/60 mb-8">
          ERROR_CODE: PAGE_NOT_FOUND // PATH_UNRESOLVED
        </p>
