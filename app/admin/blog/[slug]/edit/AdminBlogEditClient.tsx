...
export function AdminBlogEditClient({ slug }: AdminBlogEditClientProps) {
  ...
  if (!article) {
    return <div className="mx-auto w-full max-w-3xl border border-border/50 bg-card/80 p-6 text-center"><p className="font-mono text-sm text-muted-foreground">TRANSMISSION_NOT_FOUND</p><Button asChild variant="outline" className="mt-4 rounded-none font-mono"><Link href="/admin/blog" prefetch={false}>BACK_TO_LIST</Link></Button></div>;
  }
